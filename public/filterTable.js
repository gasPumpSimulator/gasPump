    ...
    while(row <= tableLength && tbody.rows.length > 0) {
        ...
        if(userChoices[3] !== "any") {
            if(userChoices[3] === "min") {
                ...
                if(tableValues[3] < userChoices[5] || tableValues[3] > userChoices[4]) {
                    table.deleteRow(row);
                    continue;
                }
            }
        ...
        if(userChoices[9] !== "any") {
            if(userChoices[9] === "min") {
                ...
                if(tableValues[6] < userChoices[11] || tableValues[6] > userChoices[10]) {
                    table.deleteRow(row);
                    continue;
                }
            }
        ...
        if(userChoices[6] !== "any") {
            if(userChoices[6] === "min") {
                ...
                if(tableValues[4] < userChoices[8] || tableValues[4] > userChoices[7]) {
                    table.deleteRow(row);
                    continue;
                }
            }
